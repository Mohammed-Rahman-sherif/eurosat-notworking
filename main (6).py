...
def main():
    ...
    parser.add_argument('--shots', type=int,  help='Number of few-shot samples')
    # Optimizer args
    parser.add_argument('--lr', type=float, help='Learning rate')
    parser.add_argument('--weight_decay', type=float,  help='Weight decay')
    parser.add_argument('--batch_size', type=int,  help='Batch size')
    # Model architecture args
    parser.add_argument('--hgt_num_layers', type=int,  help='Number of HGT layers')
    parser.add_argument('--hgt_num_heads', type=int, help='Number of HGT attention heads')
    parser.add_argument('--transformer_num_layers', type=int,  help='Number of Transformer Encoder layers')
    parser.add_argument('--transformer_nhead', type=int,  help='Number of attention heads in the transformer encoder')
    parser.add_argument('--transformer_ff_multiplier', type=int, help='Feed-forward network dimension multiplier')
    parser.add_argument('--pooling_ratio', type=float,  help='TopKPooling ratio')
    # Regularization args
    parser.add_argument('--dropout_rate', type=float,  help='Dropout rate')
    # Training args
    parser.add_argument('--train_epoch', type=int,  help='Total training epochs')
    parser.add_argument('--init_beta', type=float,  help='Initial beta for Tip-Adapter')
    parser.add_argument('--init_alpha', type=float,  help='Initial alpha for Tip-Adapter')
    parser.add_argument('--init_gamma', type=float,  help='Initial gamma for graph logits contribution')
    parser.add_argument('--lambda_con', type=float, help='Weight for the direct contrastive loss')
    parser.add_argument('--focal_loss_gamma', type=float,  help='Gamma for Focal Loss (controls hardness focus)')
    ...
    # Initialize wandb
    wandb.init(project="ICML_EuroSAT",
